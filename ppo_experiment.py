...
parser.add_argument("--learning_rate", default=float(3e-4), help="Learning rate for optimizer", type=float)
parser.add_argument("--n_steps", default=64, help="Number of steps for PPO to roll out", type=int)
parser.add_argument(
...
parser.add_argument("--seed", default=1, help="Random number seed for evaluation", type=int)
parser.add_argument("--num_of_layers", default=2, help="Number of hidden layers in the MLP", type=int)
parser.add_argument("--num_of_neurons", default=64, help="Number of neurons in each hidden layer", type=int)
parser.add_argument("--nminibatches", default=4, help="Number of mini-batches in PPO", type=int)
...
def main(kwargs: dict):
    ...
    ppo_configs = {
        ...
        "batch_size": min(number_of_cpu, kwargs["nminibatches"]),
    ...
    gym_recommendation.evaluate(
        model=model,
        env=gym.make(gym_recommendation.RecoEnv.id, **gym_recommendation.import_data_for_env()),
